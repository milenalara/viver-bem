...
void menu()
{
    ...
    printf("4 - todas as consultas por data\n");
    printf("5 - todas as consultas de um determinado medico\n");
    printf("6 - consultas ja realizadas pelo paciente\n");
    printf("7 - cancelar consulta\n");
    printf("8 - Exibir ganhos por medico\n");
}
...
void imprimeConsultaPorPaciente(FILE* f, FILE* p, FILE* m)
{
